...
namespace SIS_Model
{
    ...
    public class MStudy:ILL.IModel
    {
        ...
        { }
        #region Model
        private int _study_key;             //检查主键，数据自动生成
        ...
        private int? _security;             //密级
        private string _charge_type;        //收费类别
        ...
        private int? _series_count;         //本次检查序列总数
        private int? _instance_count;       //本次检查图片总数
        ...
        private string _exam_no;            //检查号，一般为申请单号
        ...
        private int? _exam_index;           //检查序列号，即累加值
        private int? _is_online;            //在线标识
        ...
        private string _study_path;         //检查图片路径
