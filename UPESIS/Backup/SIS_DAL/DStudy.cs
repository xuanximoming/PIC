    ...
    public class DStudy:IStudy
    {
        ...
        public override DataTable GetList1(string where)
        {
            switch (GetConfig.SisOdbcMode)
            {
                case "ACCESS":
                    strSql = "select a.*," +
                   "b.EXAM_PARA,b.DESCRIPTION as DESCRIPTION,b.IMPRESSION as IMPRESSION,b.RECOMMENDATION,b.DICTATOR,b.TRANSCRIBER,b.APPROVER,b.APPROVE_DATE_TIME,b.REPORT_DATE_TIME,b.IS_ABNORMAL,b.REPORT_TYPE,b.PRINT_COUNT,b.PRINT_TEMPLATE,b.FIELD_INF " +
                   "from " + TableName + " a left join Report b on a.EXAM_ACCESSION_NUM = b.EXAM_NO " +
                   "where " + where;
                    break;
                case "ORACLE":
                    strSql = "select a.*," +
                   "b.EXAM_PARA,b.DESCRIPTION as DESCRIPTION,b.IMPRESSION as IMPRESSION,b.RECOMMENDATION,b.DICTATOR,b.TRANSCRIBER,b.APPROVER,b.APPROVE_DATE_TIME,b.REPORT_DATE_TIME,b.IS_ABNORMAL,b.REPORT_TYPE,b.PRINT_COUNT,b.PRINT_TEMPLATE,b.FIELD_INF " +
                   "from " + TableName + " a,Report b " +
                   "where  a.EXAM_ACCESSION_NUM = b.EXAM_NO(+) and " + where;
                    break;
                case "SQL":
                    break;
            }
        ...
        public override DataTable GetList2(string where)
        {
            ...
            {
                case "ACCESS":
                    strSql = "select EXAM_ACCESSION_NUM,PATIENT_ID,PATIENT_AGE,PATIENT_SEX,PATIENT_NAME,EXAM_CLASS,EXAM_SUB_CLASS,EXAM_ITEM,STUDY_DATE_TIME,REPORT_STATUS,a.STUDY_INSTANCE_UID,REPORT_DATE_TIME from " + TableName + " a left join Report b on a.EXAM_ACCESSION_NUM = b.EXAM_NO  where " + where;
                    break;
                case "ORACLE":
                    strSql = "select EXAM_ACCESSION_NUM,PATIENT_ID,PATIENT_AGE,PATIENT_SEX,PATIENT_NAME,EXAM_CLASS,EXAM_SUB_CLASS,EXAM_ITEM,STUDY_DATE_TIME,REPORT_STATUS,a.STUDY_INSTANCE_UID,REPORT_DATE_TIME from " + TableName + " a,Report b where a.EXAM_ACCESSION_NUM = b.EXAM_NO(+) and " + where;
                    break;
                case "SQL":
                    break;
            }
