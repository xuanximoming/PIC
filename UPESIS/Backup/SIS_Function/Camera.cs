...
namespace SIS_Function
{
    ...
    public class Camera
    {
        ...
        public delegate void RecievedFrameEventHandler(System.Drawing.Bitmap bm);
        ...
        public void StartWebCam()
        {
            ...
            this.lwndC = showVideo.capCreateCaptureWindowA(lpszName, showVideo.WS_VISIBLE|showVideo.WS_CHILD, 0, 0, 640, 480, mControlPtr, 0);

            if (this.capDriverConnect(this.lwndC, 0))
            {
                this.capPreviewRate(this.lwndC, 5);
                ...
                bool ss= this.capSetVideoFormat(this.lwndC, ref bitmapinfo, showVideo.SizeOf(bitmapinfo));
                this.mFrameEventHandler = new showVideo.FrameEventHandler(framecallback);
                bool ss2 = this.capSetCallbackOnFrame(this.lwndC, this.mFrameEventHandler);
        ...
        private bool capDriverDisconnect(IntPtr lwnd)
        {
            ...
            try
            {
                success = showVideo.SendMessage(lwnd, showVideo.WM_CAP_DRIVER_DISCONNECT, 0, 0);
            }
            catch
            {
                return success;
        ...
        private void framecallback(IntPtr lwnd, IntPtr lpVHdr)
        {
            ...
            System.Drawing.Bitmap bm = ImageOpe.ByteToImage(VideoData);
            if (this.RecievedFrame != null && bm != null)
                this.RecievedFrame(bm);
        }
    }
}
