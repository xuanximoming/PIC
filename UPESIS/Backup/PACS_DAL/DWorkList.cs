...
namespace PACS_DAL
{
    ...
    public class DWorkList : IWorkList
    {
        ...
        {
            strSql = "select a.*," +
                     "b.EXAM_PARA,b.DESCRIPTION,b.IMPRESSION,b.RECOMMENDATION,b.DICTATOR,b.TRANSCRIBER,b.APPROVER,b.APPROVE_DATE_TIME,b.REPORT_DATE_TIME,b.IS_ABNORMAL,b.REPORT_TYPE,b.PRINT_COUNT,b.PRINT_TEMPLATE,b.FIELD_INF," +
                     "c.AREA_NAME " +
