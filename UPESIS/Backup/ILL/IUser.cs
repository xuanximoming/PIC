...
{
    /// <summary>
    /// 继承DBControl的抽象类IUser,操作System_Users,Fpax_Users，SIS和PACS的用户表
    /// </summary>
    public abstract class IUser : DBControl
    {
        public IUser(ConParam cps)
            : base(cps)
        {
        }
        ...
        public virtual DataTable GetListMultiRole(string where)
        {
            return null;
        }
