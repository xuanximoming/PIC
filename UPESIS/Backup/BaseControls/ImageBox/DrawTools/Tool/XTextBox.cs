...
namespace BaseControls.ImageBox.DrawTools
{
    public class XTextBox : System.Windows.Forms.TextBox
    {
        ...
        private bool m_Min = false;
        private bool m_Max = false;
        ...
        public XTextBox(Control Parent)
        {
            ...
            this.myBackAlpha = 0;
            this.Font = Properties.Settings.Default.Font_XTextBox;
            this.ForeColor = Properties.Settings.Default.ForeColor_XTextBox;
