...
namespace BaseControls.ImageBox.Imaging.Textures
{
	using System;
	...
	public class LabyrinthTexture : ITextureGenerator
	{
        ...
        private BaseControls.ImageBox.Math.PerlinNoise noise = new BaseControls.ImageBox.Math.PerlinNoise( 1.0 / 16, 1.0, 0.65, 1 );
