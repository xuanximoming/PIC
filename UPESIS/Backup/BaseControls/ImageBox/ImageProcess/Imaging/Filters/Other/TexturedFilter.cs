...
namespace BaseControls.ImageBox.Imaging.Filters
{
	...
	{
        // texture generator
        private BaseControls.ImageBox.Imaging.Textures.ITextureGenerator textureGenerator;
        // generated texture
        ...
        /// 
        public BaseControls.ImageBox.Imaging.Textures.ITextureGenerator TextureGenerator
		{
        ...
        /// <param name="filter1">First filter</param>
        /// 
		public TexturedFilter( BaseControls.ImageBox.Imaging.Textures.ITextureGenerator generator, IFilter filter1 )
		{
        ...
        /// <param name="filter2">Second filter</param>
        /// 
		public TexturedFilter( BaseControls.ImageBox.Imaging.Textures.ITextureGenerator generator, IFilter filter1, IFilter filter2 )
		{
			this.textureGenerator = generator;
			this.filter1 = filter1;
			this.filter2 = filter2;
