...
namespace BaseControls.Ribbon
{
        ...
        : RibbonRenderer
    {
        ...
        public void DrawPanelNormal(RibbonPanelRenderEventArgs e)
        {
            ...
            {
                DrawButtonMoreGlyph(e.Graphics, e.Panel.ButtonMoreBounds, e.Panel.ButtonMoreEnabled);
            }
        ...
        public void DrawPanelOverflowImage(RibbonPanelRenderEventArgs e)
        {
            ...
            using (SolidBrush b = new SolidBrush(ColorTable.Text))
            {
        ...
        public void DrawButtonDropDownArrow(Graphics g, RibbonButton button, Rectangle textLayout)
        {
            ...
            DrawArrow(g, boundsLight, lt, Direction.Down);
            DrawArrow(g, bounds, dk, Direction.Down);
        }
        ...
        {
            using (Brush b = new SolidBrush(ColorTable.Text))
            {
        ...
        public override void OnRenderRibbonItemText(RibbonItemBoundsEventArgs e)
        {
            if (e.Item is RibbonButton)
            {
                ...
                using (SolidBrush brush = new SolidBrush(ColorTable.Text))
                {
        ...
        public override void OnRenderRibbonItemImage(RibbonItemBoundsEventArgs e)
        {
            if (e.Item is RibbonButton)
            {
                ...
                {
                    e.Graphics.DrawImage((e.Item as RibbonButton).SmallImage, e.Bounds);
                } 
            }
        }
