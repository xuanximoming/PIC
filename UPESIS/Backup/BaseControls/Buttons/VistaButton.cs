...
{
    /// <summary>
    /// A replacement for the Windows Button Control，vista按钮
    /// </summary>
    [DefaultEvent("Click")]
    public partial class VistaButton : System.Windows.Forms.UserControl
    {
        ...
        /// <summary>
        /// The text that is displayed on the button.文本内容
        /// </summary>
        [Category("Text"),
        ...
        /// <summary>
        /// The color with which the text is drawn.文本颜色
        /// </summary>
        [Category("Text"),
         Browsable(true),
        ...
        /// that is displayed on the control.文本布局
        /// </summary>
        [Category("Text"),
        ...
        /// is used to help the user identify　　　　图像设置或获取
        ...
        /// in relation to the button.　　　　图像布局
        /// </summary>
        [Category("Image"),
        ...
        /// button. This property defaults to 24x24.　　　　图像大小
        /// </summary>
        [Category("Image"),
        ...
        /// while the mouse is outside of the client area.　按钮风格
        /// </summary>
        [Category("Appearance"),
        ...
        /// <summary>
        /// The color of the highlight on the top of the button.　高亮的颜色
        /// </summary>
        [Category("Appearance"),
         DefaultValue(typeof(Color), "White"),
        ...
        /// will be drawn over the base color.　　　　按钮底色
        /// </summary>
        [Category("Appearance"),
        ...
        /// the mouse is inside the client area.　鼠标于其上，所显示颜色
        /// </summary>
        [Category("Appearance"),
        ...
        /// effect set this property to Transparent.　　按钮基础颜色
        /// </summary>
        [Category("Appearance"),
         DefaultValue(typeof(Color), "Black"),
        ...
        private void InitializeComponent()
        {
            ...
            this.Font = Properties.Settings.Default.Font_VistaButton;
            this.ForeColor = Properties.Settings.Default.ForeColor_VistaButton;
