...
namespace BaseControls
{
    ...
    public partial class RowMergeView : DataGridView
    {
        ...
        /// <returns>图形</returns>
        public Image GetDataGridViewToImage()
        {
            this.Dock = DockStyle.None;
            PictureBox _NewPictureBox = new PictureBox();
            _NewPictureBox.Size = this.Size;
            _NewPictureBox.Location = this.Location;
            Bitmap _ViewBmp = new Bitmap(_NewPictureBox.Width, _NewPictureBox.Height);
            this.DrawToBitmap(_ViewBmp, new System.Drawing.Rectangle(0, 0, _NewPictureBox.Width, _NewPictureBox.Height));
            _NewPictureBox.Image = _ViewBmp;
            this.Parent.Controls.Add(_NewPictureBox);

            this.Visible = false;
            this.AutoSize = true;

            Bitmap _NewBitmap = new Bitmap(this.Width, this.Height - 32);
            this.DrawToBitmap(_NewBitmap, new System.Drawing.Rectangle(0, 0, this.Width, this.Height));

            this.AutoSize = false;
            this.Visible = true;

            this.Parent.Controls.Remove(_NewPictureBox);
            _ViewBmp.Dispose();
