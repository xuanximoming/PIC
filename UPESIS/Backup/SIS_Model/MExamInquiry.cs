...
namespace SIS_Model
{
    ...
    public class MExamInquiry:ILL.IModel
    {
        ...
        private string _impression;         //影像
        private string _approver;           //审核医生
        private string _transcriber;        //报告医生
        private string _oper_dept_name;     //手术科室名称
        private string _surgeon;            //手术医生
        private DateTime? _oper_date;       //手术日期
        ...
        private string _inqu_doctor;        //随访医生
        private DateTime? _inqu_date_time;  //随访日期
        private string _inqu_dept_code;     //随访医生科室代码
