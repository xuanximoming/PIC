...
namespace BaseControls.ImageBox.DrawTools
{
    ...
    /// </summary>
  public  class DrawPolygon : BaseControls.ImageBox.DrawTools.DrawLine
    {
        public PointList pointArray;         // list of points
        private static System.Reflection.Assembly assembly = System.Reflection.Assembly.GetExecutingAssembly();
        private static System.Resources.ResourceManager rm = new System.Resources.ResourceManager("BaseControls.ImageBox.Resources", assembly);
        private static Cursor handleCursor = (System.Windows.Forms.Cursor)(rm.GetObject("PolyHandle"));
