...
namespace BaseControls.ImageBox.DrawTools.DocToolkit
{
    /// <summary>
    ...
    public class PersistWindowState
    {
        ...
        private void OnResize(object sender, System.EventArgs e)
        {
            ...
            if (ownerForm.ParentForm.WindowState == FormWindowState.Normal)
            {
                normalWidth = ownerForm.Width;
                normalHeight = ownerForm.Height;
            }
        ...
        private void OnMove(object sender, System.EventArgs e)
        {
            ...
            // save state
            windowState = ownerForm.ParentForm.WindowState;
        }
        ...
        private void OnLoad(object sender, System.EventArgs e)
        {
            ...
            if (key != null)
            {
                ...
                FormWindowState windowState = (FormWindowState)key.GetValue("WindowState", (int)ownerForm.ParentForm.WindowState);

                ownerForm.Location = new Point(left, top);
                ownerForm.Size = new Size(width, height);
                ownerForm.ParentForm.WindowState = windowState;
            }
        }
