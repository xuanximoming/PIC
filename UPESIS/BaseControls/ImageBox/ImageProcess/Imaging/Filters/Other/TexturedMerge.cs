...
namespace BaseControls.ImageBox.Imaging.Filters
{
    ...
    public class TexturedMerge : FilterAnyToAny
	{
        ...
        /// 
        public TexturedMerge( BaseControls.ImageBox.Imaging.Textures.ITextureGenerator generator )
		{
        ...
        /// <param name="overlayImage">Overlay image</param>
        /// 
		public TexturedMerge( BaseControls.ImageBox.Imaging.Textures.ITextureGenerator generator, Bitmap overlayImage )
		{
			this.textureGenerator = generator;
			this.overlayImage = overlayImage;
		}
