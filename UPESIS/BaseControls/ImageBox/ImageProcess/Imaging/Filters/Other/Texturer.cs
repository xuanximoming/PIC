...
namespace BaseControls.ImageBox.Imaging.Filters
{
    ...
    public class Texturer : FilterAnyToAny
	{
        ...
        /// 
		public Texturer( BaseControls.ImageBox.Imaging.Textures.ITextureGenerator generator )
		{
        ...
        /// <param name="preserveLevel">Preserve level value</param>
        /// 
        public Texturer( BaseControls.ImageBox.Imaging.Textures.ITextureGenerator generator, double filterLevel, double preserveLevel )
		{
			this.textureGenerator   = generator;
			this.filterLevel        = filterLevel;
            this.preserveLevel      = preserveLevel;
