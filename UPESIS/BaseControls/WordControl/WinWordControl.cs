...
namespace BaseControls
{
    ...
    public class WinWordControl : System.Windows.Forms.UserControl
    {
		...
		*/
        ...
        public ApplicationClass wd = null;
        public int wordWnd = 0;
        public static string filename = null;
        private static bool deactivateevents = false;
        private bool showToolBar = true;
        private bool showMenuBar = true;
        private bool setMenuBar = true;//是否初始化菜单栏

        [DefaultValue(typeof(bool), "true"), Description("Is Show The Toolbar.")]
        ...
        [DefaultValue(typeof(bool), "true"), Description("Is Show The Menubar.")]
        public virtual bool ShowMenuBar
        {
            get { return showMenuBar; }
            set { this.showMenuBar = value; }
        }
        /// <summary>
        ...
        public void LoadDocument(string t_filename)
        {
            ...
            if (wordWnd != 0)
            {
                ...
                //                {
                //                    if (wd.ActiveWindow.Application.CommandBars[i].Controls[j].TooltipText == "关闭预览")
                //                        //MessageBox.Show(wd.ActiveWindow.Application.CommandBars[i].Controls[j].ToString());
                //                        wd.ActiveWindow.Application.CommandBars[i].Controls[j].Enabled = false;
                //                }
                //            }
