    ...
    class TabPageSwitcherDesigner : ParentControlDesigner {
        ...
        public override System.ComponentModel.Design.DesignerVerbCollection Verbs {
            get {
                if (verbs == null) {
                    ...
                    verbs.Add(new DesignerVerb(BaseControls.Properties.Resources.AddTab, new EventHandler(this.OnAdd)));         
                }
        ...
        private void OnAdd(object sender, EventArgs eevent) {
            ...
            if (host != null) {
                ...
                try {
                    try {
                        t = host.CreateTransaction(BaseControls.Properties.Resources.AddTab + Component.Site.Name);
                    }
