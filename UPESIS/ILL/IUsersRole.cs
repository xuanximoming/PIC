...
{
    /// <summary>
    /// 继承DBControl的抽象类IUsersRole,操作Users_Role，SIS的用户角色表
    /// </summary>
    public abstract class IUsersRole : DBControl
    {
        public IUsersRole(ConParam cps)
            : base(cps)
        {
        }
        ...
        public virtual int Update2(IModel iModel, string where)
        {
            return -1;
        }
